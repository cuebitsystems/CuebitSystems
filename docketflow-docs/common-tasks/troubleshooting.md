...
description: "Fixes for common situations, by symptom."
---
...
| Docket stuck Queued / Pending sync | Connect to the internet and keep the app open briefly so sync can finish. |
...
:::note
Need more help? Ask your organisation's Administrator for account access, contract setup, and staff allocation. This guide describes the tenant app only.
:::
